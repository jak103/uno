...
<template>
  <div>
    <v-container>
      <!-- <v-row :class="'mb-6'">
        <v-col :cols="6"> -->
            <h1 class=text >The first player is normally the player to the left of the dealer (you can also choose the youngest player) and gameplay usually follows a clockwise direction. Every player views his/her cards and tries to match the card in the Discard Pile.
